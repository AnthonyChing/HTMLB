...
# List of columns to fill by averaging the previous 10 games
rolling_columns = [
...
def process_team_file(team_path):
    ...
    # Compute rolling average of the previous 10 games per season
    group_keys = ['season']
    for col in rolling_columns:
        # Shift by 1 to ensure we don't include the current game in its own average
