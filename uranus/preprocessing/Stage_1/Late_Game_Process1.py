...
def prepare_data(input_file='undropped_train.csv', 
    ...
    try:
        ...
        X_train.to_csv(os.path.join(processed_data_dir, 'X_train_1.csv'), index=False)
        y_train.to_csv(os.path.join(processed_data_dir, 'y_train_1.csv'), index=False)
        X_val.to_csv(os.path.join(processed_data_dir, 'X_val_1.csv'), index=False)
        y_val.to_csv(os.path.join(processed_data_dir, 'y_val_1.csv'), index=False)
