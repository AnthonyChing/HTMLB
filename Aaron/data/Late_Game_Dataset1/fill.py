...
data1 = pd.read_csv(os.getcwd() + "/train_data_1.csv")
data2 = pd.read_csv(os.getcwd() + "/val_data_1.csv")
data = [data1, data2]
...
data[0].to_csv("train_data_1_f.csv", index=False)
data[1].to_csv("val_data_1_f.csv", index=False)