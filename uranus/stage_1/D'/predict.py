...
def remove_columns(data_file='../../../stage 1/same_season_test_data.csv', drop_file='../../feature_importance_LightGBM/drop100.txt'):
    """
    ...
    try:
        ...
        if cleaned_data is not None:
            cleaned_data.to_csv('cleaned_same_season_test_data.csv', index=False)
            print("Cleaned data saved as 'cleaned_same_season_test_data.csv'.")
...
def main():
    ...
    predict_path = 'cleaned_same_season_test_data.csv'
